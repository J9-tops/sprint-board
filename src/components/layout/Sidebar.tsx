...
import { KanbanSquare, Filter, X } from "lucide-react";
  ...
  return (
    <>
      ...
      <aside className={cn(
        ...
        isOpen ? "w-72 translate-x-0" : "w-0 -translate-x-full md:translate-x-0 md:border-r-0"
      )}>
        <div className={cn(
          ...
          <div className="flex items-center justify-between shrink-0">
            <div className="flex items-center gap-2 px-2 rounded-lg outline-none">
              ...
              <span className="font-bold text-xl tracking-tight text-foreground select-none">TaskMaster</span>
            </div>
            <Button 
              variant="ghost" 
              size="icon" 
