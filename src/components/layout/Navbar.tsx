  ...
  return (
    <header className="h-16 border-b flex items-center justify-between px-4 md:px-6 shrink-0 bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/60 sticky top-0 z-30">
      <div className="flex items-center gap-4 md:gap-8 flex-1">
        ...
        <Link
          to="/"
          className="flex items-center gap-2 px-2 rounded-lg outline-none focus-visible:ring-2 focus-visible:ring-primary"
        >
      ...
      <nav className="hidden md:flex items-center gap-6 px-4">
        ...
        <Link
          to="/"
          className="text-sm font-bold text-foreground border-b-2 border-primary py-5 translate-y-px"
        >
          Boards
        </Link>
        <Link
      ...
      <div className="flex items-center gap-2 md:gap-3 flex-1 justify-end">
        ...
        <Button
          variant="ghost"
          size="icon"
          className="h-9 w-9 text-muted-foreground hover:bg-muted/80"
        >
          <Bell size={18} />
        </Button>
        <Button
          variant="ghost"
          size="icon"
          className="hidden sm:inline-flex h-9 w-9 text-muted-foreground hover:bg-muted/80"
        >
          <HelpCircle size={18} />
        </Button>
