    ...
    <article className="w-[320px] flex flex-col gap-4 shrink-0 bg-muted/30 rounded-2xl p-4 h-fit max-h-full border border-border/50 shadow-sm focus-within:ring-2 focus-within:ring-primary/10 outline-none transition-all">
      <div className="flex items-center justify-between px-1">
        <div className="flex items-center gap-2">
          <h3 className="font-bold text-sm select-none uppercase tracking-widest text-foreground">{title}</h3>
          <Badge variant="secondary" className="h-5 px-1.5 text-[10px] bg-muted-foreground/10 text-muted-foreground border-none select-none font-bold">
            {cardCount}
          </Badge>
        </div>
        <Button 
