import { 
  Tag, CheckSquare, Clock, Paperclip, Image,
  ArrowRight, Copy, Archive 
} from "lucide-react";
    ...
    <div className="w-48 space-y-6">
      {sections.map((section) => (
        <div key={section.title} className="space-y-2">
          <h4 className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.15em] px-2">{section.title}</h4>
