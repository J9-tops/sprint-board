    ...
    <div className="flex items-start gap-4 w-full px-1">
      ...
      <div className="flex-1 space-y-1">
        ...
        <p className="text-xs text-muted-foreground font-medium px-0.5">
          in list{' '}
          <button className="underline decoration-muted-foreground/50 underline-offset-4 cursor-pointer hover:text-foreground transition-colors outline-none focus-visible:text-primary focus-visible:decoration-primary">
            Doing
          </button>
        </p>
      </div>
