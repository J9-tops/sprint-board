  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        <h4 className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest px-1">Solid Colors</h4>
        <div className="grid grid-cols-5 gap-2">
          {colors.map((color) => (
            <button 
              ...
              title={color.name}
            >
              {selected === color.value && <Check size={14} className="text-white drop-shadow-sm" />}
            </button>
          ))}
        </div>
      </div>
      ...
      <div className="space-y-2">
        <h4 className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest px-1">Gradients</h4>
        <div className="grid grid-cols-5 gap-2">
          {gradients.map((gradient) => (
            <button
              ...
              title={gradient.name}
            >
              {selected === gradient.value && <Check size={14} className="text-white drop-shadow-sm" />}
            </button>
          ))}
        </div>
      </div>
