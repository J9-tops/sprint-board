import { KanbanSquare, Plus, Zap, Shield, HardDrive } from "lucide-react";
...
export function WelcomeScreen({ onCreateFirstBoard }: WelcomeScreenProps) {
  const features = [
    { 
      ...
      description: "Everything is stored locally in your browser for zero latency." 
    },
    { 
      icon: Shield, 
      title: "Complete Privacy", 
      description: "Your data never leaves your device. No accounts, no tracking." 
    },
    { 
      icon: HardDrive, 
      title: "Offline First", 
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] text-center max-w-2xl mx-auto space-y-10 px-6">
      <div className="space-y-4">
        ...
        <h1 className="text-5xl font-black tracking-tighter">Welcome to KanbanOffline</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
        {features.map((f) => (
          <div key={f.title} className="space-y-2 p-4 rounded-2xl bg-muted/30 border border-border/50">
